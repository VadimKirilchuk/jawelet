...
public final class ArithCodeInputStream extends InputStream {
	...
	/**
	 * Construct an arithmetic coded input stream from a specified arithmetic
	 * decoder and a statistical model.
	 * 
	 * @param decoder
	 *            Arithmetic decoder from which to read input events.
	 * @param model
	 *            Statistical model for arithmetic coding.
	 * @throws IOException
	 *             If there is an I/O exception in the underlying input stream.
	 */
	...
	/**
	 * Construct an arithmetic coded input stream from a specified bit input and
	 * a statistical model.
	 * 
	 * @param bitIn
	...
	/**
	 * Construct an arithmetic coded input stream from a specified buffered
	 * input stream and a statistical model.
	 * 
	 * @param in
	 *            Buffered input stream from which to read coded bits.
	 * @param model
	 *            Statistical model for arithmetic coding.
	 * @throws IOException
	 *             If there is an I/O exception in the underlying input stream.
	...
	public ArithCodeInputStream(BufferedInputStream in, ArithCodeModel model) throws IOException {
		this(new BitInputImpl(in), model);
	}

	/**
	 * Construct an arithmetic coded input stream from a specified input stream
	 * and a statistical model.
	 * 
	 * @param in
	 *            Input stream from which to read coded bits.
	 * @param model
	 *            Statistical model for arithmetic coding.
	 * @throws IOException
	 *             If there is an I/O exception in the underlying input stream.
	...
	/**
	 * Returns <code>1</code> if there is at least one byte available to be read
	 * and returns <code>0</code> otherwise.
	 * 
	 * @return <code>1</code> if at least one byte is available and
